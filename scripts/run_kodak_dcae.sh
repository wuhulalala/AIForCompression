#!/bin/bash
#SBATCH --job-name=kodak_dcae
#SBATCH --partition=gpu_5090
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --export=NONE
#SBATCH --output=/data/run01/scxj523/zsh/project/AIForCompression/logs/kodak_dcae_%j.log
#SBATCH --error=/data/run01/scxj523/zsh/project/AIForCompression/logs/kodak_dcae_%j.log

set -eo pipefail

ROOT=/data/run01/scxj523/zsh/project/AIForCompression
KODAK=/data/run01/scxj523/zsh/project/Data/Kodac
OUTDIR=$ROOT/unified_results/kodak_dcae_only
