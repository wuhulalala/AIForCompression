#!/bin/bash
#SBATCH --job-name=caesar_models_268
#SBATCH --partition=gpu_5090
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/data/run01/scxj523/zsh/project/AIForCompression/logs/caesar_models_268_%j.log
#SBATCH --error=/data/run01/scxj523/zsh/project/AIForCompression/logs/caesar_models_268_%j.log
