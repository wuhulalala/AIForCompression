#!/bin/bash
#SBATCH --job-name=nyx_dace_hpcm
#SBATCH --partition=gpu_5090
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --output=../logs/nyx_dace_hpcm_%j.log
#SBATCH --error=../logs/nyx_dace_hpcm_%j.log
...
python scripts/run_dataset_compression.py \
  --dataset nyx \
  --data_root /data/run01/scxj523/zsh/project/Data/nyx/SDRBENCH-EXASKY-NYX-512x512x512 \
  --output_dir unified_results/nyx \
